...
export default function SignIn() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col lg:flex-row">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3">
              <Button
                variant="outline"
                className="w-full h-12 text-base font-normal bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700"
      ...
      <div className="flex-1 bg-gray-100 dark:bg-gray-800 flex items-center justify-center p-4 lg:p-8">
