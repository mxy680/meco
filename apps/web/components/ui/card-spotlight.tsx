...
export function CardDemo() {
  return (
    <Card>
      ...
      <CardTitle>Darwin meets machine learning</CardTitle>
      <CardDescription>
        MECO automates ML pipeline creation and optimizes code functions through
        iterative AI-driven evolution.
      </CardDescription>
    </Card>
  );
}
